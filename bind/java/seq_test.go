...
import (
	...
	"github.com/csiimobile/mobile/internal/importers/java"
)
...
func TestClasses(t *testing.T) {
	...
	runTest(t, []string{
		"github.com/csiimobile/mobile/bind/testdata/testpkg/javapkg",
	}, "", "ClassesTest")
}
...
func TestJavaSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/csiimobile/mobile/bind/testdata/benchmark"}, "", "SeqBench")
}
